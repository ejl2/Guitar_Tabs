...
public class Example3{
  public static void main(String[] args){
    try{
      ...
      System.out.println("body's text: " + body.getChildText());   //join child text of body element
      System.out.println("body's innerText: " + body.innerText()); //join all text within body element
      System.out.println("div's text: " + div.getChildText());     //join child of div element
